...
app.controller("BenignCtrl", function($scope, $http) {
    ...
    var jsonFile = ["fp_benign_suspicious_data_01.json", "fp_benign_suspicious_data_02.json", "fp_benign_suspicious_data_03.json"];
...
app.controller("ActiveCasesCtrl", function($scope, $http) {
    $http.get('../data/fp_active_cases_investigator_level_data.json')
        .then(function(response) {
            //console.log(response.data);
...
app.controller("investigatorsSummaryCtrl", function($scope, $http) {
   $http.get('../data/fp_active_cases_investigators_summary.json')
        .then(function(response) {
...
app.controller("StatisticsCtrl", function($scope, $http) {
   $http.get('../data/fp_statistics_data.json')
        .then(function(response) {
...
app.controller("CaseDetailsCtrl", function($scope, $http) {
   $http.get('../data/fp_case_details_info_data.json')
        .then(function(response) {
