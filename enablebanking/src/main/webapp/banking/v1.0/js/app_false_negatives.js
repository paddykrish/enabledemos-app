...
app.controller("TransactionsCtrl", function($scope, $http) {
    ...
    function loadData(file) {
        $scope.data = [];
        $http.get('/enablebanking/service/dataservice/getFPTransactions/all/')
            .then(function(response) {
                //console.log(response.data);
                var x = 0;
                $scope.data = response.data;
...
app.controller("CasesOpenedCtrl", function($scope, $http) {
    ...
    function loadCasedOpened(file) {
        $http.get('/enablebanking/service/dataservice/getFNCaseOpenedData/all/')
            .then(function(response) {
                //console.log(response.data);
                $scope.data = response.data;
            }); 
...
app.controller("BenignCtrl", function($scope, $http) {
    ...
    var jsonFile = ["fn_benign_data_01.json", "fn_benign_data_02.json", "fn_benign_data_03.json"];
    ...
    function loadBenign(file) {
        $http.get('/enablebanking/service/dataservice/getFNBenignData/all/')
            .then(function(response) {
                console.log(response.data);
                $scope.data = response.data;
            }); 
